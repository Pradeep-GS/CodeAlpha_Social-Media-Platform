...
const Post = ({ data }) => {
  ...
  return (
    <>
      {/* Main Post Card */}
      <div className='max-w-lg mx-auto my-6 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden'>
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className='font-bold text-sm'>{data.user.username}</p>
        ...
        <div className='px-4 pb-3'>
          ...
          <p className='text-sm mb-2'>
            <span className='font-bold mr-2'>{data.user.username}</span>
            {data.caption}
          </p>
